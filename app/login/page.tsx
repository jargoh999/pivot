    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <div className="w-full max-w-md p-4 sm:p-6">
                ...
                {/* Heading */}
                <h1 className="text-2xl font-bold text-center text-[#e83f55] mb-8">Welcome back</h1>
                ...
                <div className="space-y-4 mb-6">
                    ...
                    <div>
                        ...
                        <div className="text-right mt-2">
                            <button className="text-sm text-[#e83f55] hover:underline">
                                Forgot password?
                            </button>
                        </div>
                    </div>
                ...
                <Button
                    onClick={handleLogin}
                    className="w-full h-14 bg-[#e83f55] hover:bg-[#d62a3f] text-white font-semibold rounded-xl mb-6"
                    disabled={isLoading}
                >
                ...
                <p className="text-center text-gray-600 text-sm">
                    ...
                    <Link href="/signup" className="text-[#e83f55] font-semibold hover:underline">
                        Sign up
                    </Link>
                </p>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                    <p className="text-xs text-gray-500 text-center">
                        ...
                        and{" "}
                        <Link href="/privacy" className="text-[#e83f55] hover:underline">
                            Privacy Policy
                        </Link>
                        .
                    </p>
